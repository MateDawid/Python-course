...
from question import Question #import z pliku question.py

app = Flask(__name__)
questions = []
questions.append(Question(0,"Czy Flask to biblioteka mobilna?",False))
questions.append(Question(1,"Czy pętla fot jest w Pythonie?",True))
questions.append(Question(2,"Czy 4/2 to 2 w Pythonie?",False))
questions.append(Question(3,"Czy w if potrzebny jest średnik?",False))
